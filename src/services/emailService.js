...
export class EmailService {
     ...
     */
    static async sendNewsletter(params) {
        try {
     ...
     */
    static async sendEmailBatch(subscribers, emailData) {
        try {
     ...
     */
    static async generateUnsubscribeToken(subscriberId) {
     ...
     */
    static async updateNewsletterStatus(newsletterId, updates) {
     ...
     */
    static async logNewsletterSend(newsletterId, stats) {
        if (!newsletterLogsEnabled)
            return;
        try {
            await supabase
     ...
     */
    static async getSendStatistics(newsletterId) {
     ...
     */
    static previewTemplate(templateId, variables) {
     ...
     */
    static async sendTestEmail(templateId, variables, testEmail) {
        try {
