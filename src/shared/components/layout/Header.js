...
export function Header() {
    ...
    return (_jsx("header", { className: "bg-white dark:bg-slate-900 shadow-sm sticky top-0 z-50 border-b border-gray-100 dark:border-slate-700 backdrop-blur-sm", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "flex justify-between items-center py-2", children: [_jsx(Link, { to: "/", className: "flex items-center", children: _jsx("img", { src: logoImage, alt: "Yogodyaan Logo", className: "h-16 w-16 object-contain rounded-full" }) }), _jsx("nav", { className: "hidden md:flex space-x-8", children: navigation.map((item) => (_jsx(Link, { to: item.href, className: `font-medium transition-colors duration-200 ${isActive(item.href)
