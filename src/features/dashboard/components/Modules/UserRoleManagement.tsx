            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {availableRoles.map((role) => (
                  <div
                    key={role.id}
                    className={`border rounded-lg p-3 cursor-pointer hover:bg-gray-100 transition-colors ${selectedRoles.includes(role.name)
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <span className={`font-medium capitalize ${role.name === 'admin' || role.name === 'super_admin'
                        ? 'text-red-600'
                        : 'text-gray-900'
                        }`}>
                        {role.name}
