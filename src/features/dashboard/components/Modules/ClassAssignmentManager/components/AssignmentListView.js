                            ...
                            return (_jsxs("div", { className: "px-6 py-4 hover:bg-gray-50 transition-colors cursor-pointer", onClick: (e) => {
                                    ...
                                    if (!isSelectMode) {
                                        onOpenClassDetails(assignment);
                                                        ...
                                                        }, children: _jsx("input", { type: "checkbox", checked: selectedAssignments.has(assignment.id), onChange: () => onToggleSelection(assignment.id), className: "h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" }) })), _jsx("div", { className: "flex-shrink-0", children: _jsx("span", { className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${statusStyle.bgColor} ${statusStyle.borderColor} ${statusStyle.textColor}`, children: statusStyle.label }) }), _jsx("div", { className: "flex-1 min-w-0", children: _jsxs("div", { className: "flex items-center space-x-6", children: [_jsxs("div", { className: "flex items-center text-sm text-gray-600", children: [_jsx(Calendar, { className: "w-4 h-4 mr-1" }), formatDate(assignment.date)] }), _jsxs("div", { className: "flex items-center text-sm text-gray-600", children: [_jsx(Clock, { className: "w-4 h-4 mr-1" }), formatTime(assignment.start_time), " - ", formatTime(assignment.end_time)] }), getClientNames(assignment) && getClientNames(assignment) !== group.groupInfo.client_names && (_jsxs("div", { className: "flex items-center text-sm text-gray-600", children: [_jsx(MapPin, { className: "w-4 h-4 mr-1" }), getClientNames(assignment)] }))] }) })] }), _jsxs("div", { className: "flex items-center space-x-4", children: [_jsxs("div", { className: "text-right", children: [_jsxs("div", { className: "flex items-center text-lg font-semibold text-green-600", children: [_jsx(IndianRupee, { className: "w-4 h-4" }), "\u20B9", assignment.payment_amount.toFixed(2)] }), assignment.payment_status && (_jsx("div", { className: `text-xs ${assignment.payment_status === 'paid' ? 'text-green-600' :
