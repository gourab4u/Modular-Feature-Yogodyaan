...
export const calculateCourseEndDate = (startDate: string, duration: number, unit: string) => {
...
export const calculateWeeklyClasses = (startDate: string, endDate: string) => {
    const start = new Date(startDate)
...
export const calculateCourseClasses = (duration: number, unit: string, frequency: string) => {
...
export const getClassStatus = (assignment: ClassAssignment) => {
...
export const getStatusStyle = (assignment: ClassAssignment) => {
