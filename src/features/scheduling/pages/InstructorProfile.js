...
export default function InstructorProfile() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-900", children: [_jsxs("div", { className: "bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 relative overflow-hidden", children: [_jsx("div", { className: "absolute inset-0 bg-black bg-opacity-20" }), _jsxs("div", { className: "relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [_jsxs("button", { onClick: () => navigate(-1), className: "mb-6 text-white hover:text-blue-200 transition-colors flex items-center", children: [_jsx(ArrowLeft, { className: "w-5 h-5 mr-2" }), "Back to Schedule"] }), _jsxs("div", { className: "flex flex-col md:flex-row items-start md:items-center space-y-6 md:space-y-0 md:space-x-8", children: [_jsxs("div", { className: "relative", children: [instructor.avatar_url ? (_jsx("img", { src: instructor.avatar_url, alt: instructor.full_name, className: "w-32 h-32 rounded-full object-cover border-4 border-white shadow-xl", onError: (e) => {
                            ...
                            return (_jsxs("button", { onClick: () => setActiveTab(tab.id), className: `flex items-center space-x-2 py-4 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === tab.id
                                    ...
                                    : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:border-gray-300 dark:hover:border-gray-600'}`, children: [_jsx(Icon, { className: "w-4 h-4" }), _jsx("span", { children: tab.label })] }, tab.id));
                        }) }) }) }), _jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [activeTab === 'about' && (_jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [_jsxs("div", { className: "lg:col-span-2 space-y-8", children: [instructor.bio && (_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8", children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center", children: [_jsx(BookOpen, { className: "w-6 h-6 mr-3 text-blue-600" }), "About ", instructor.full_name.split(' ')[0]] }), _jsx("div", { className: "text-gray-700 dark:text-gray-300 leading-relaxed text-lg", dangerouslySetInnerHTML: { __html: instructor.bio } })] })), instructor.teaching_philosophy && (_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 dark:text-white mb-6", children: "Teaching Philosophy" }), _jsx("div", { className: "bg-blue-50 dark:bg-blue-900 border-l-4 border-blue-400 p-6 rounded-r-lg", children: _jsxs("p", { className: "text-gray-700 dark:text-gray-300 leading-relaxed italic text-lg", children: ["\"", instructor.teaching_philosophy, "\""] }) })] })), instructor.languages && instructor.languages.length > 0 && (_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 dark:text-white mb-6", children: "Languages" }), _jsx("div", { className: "flex flex-wrap gap-3", children: instructor.languages.map((language, index) => (_jsx("span", { className: "bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-4 py-2 rounded-full text-sm font-medium border border-purple-200 dark:border-purple-700", children: language }, index))) })] }))] }), _jsxs("div", { className: "space-y-6", children: [instructor.achievements && instructor.achievements.length > 0 && (_jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6", children: [_jsxs("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center", children: [_jsx(Award, { className: "w-5 h-5 mr-2 text-yellow-500" }), "Achievements"] }), _jsx("div", { className: "space-y-3", children: instructor.achievements.map((achievement, index) => (_jsxs("div", { className: "flex items-start space-x-3", children: [_jsx("div", { className: "w-2 h-2 bg-yellow-400 rounded-full mt-2 flex-shrink-0" }), _jsx("p", { className: "text-gray-700 dark:text-gray-300 text-sm", children: achievement })] }, index))) })] })), _jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6", children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4", children: "Quick Actions" }), _jsxs("div", { className: "space-y-3", children: [_jsxs(Button, { className: "w-full", onClick: () => setActiveTab('classes'), children: [_jsx(Calendar, { className: "w-4 h-4 mr-2" }), "View Class Schedule"] }), _jsx(Button, { variant: "outline", className: "w-full", onClick: () => navigate('/schedule'), children: "Book a Class" }), _jsxs(Button, { variant: "outline", className: "w-full", onClick: () => window.location.href = `mailto:${instructor.email}`, children: [_jsx(Mail, { className: "w-4 h-4 mr-2" }), "Contact Instructor"] })] })] })] })] })), activeTab === 'classes' && (_jsx("div", { className: "space-y-6", children: _jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6", children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center", children: [_jsx(Calendar, { className: "w-6 h-6 mr-3 text-blue-600" }), "Weekly Class Schedule"] }), schedules.length === 0 ? (_jsxs("div", { className: "text-center py-12", children: [_jsx(Calendar, { className: "w-16 h-16 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white mb-2", children: "No Classes Scheduled" }), _jsx("p", { className: "text-gray-500 dark:text-gray-400", children: "This instructor doesn't have any classes scheduled at the moment." })] })) : (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: schedules.map((schedule) => {
                                        ...
                                        return (_jsxs("div", { className: `border rounded-xl p-6 hover:shadow-lg transition-all duration-200 ${userHasBooked
                                                ...
                                                : isFullyBooked
                                                    ...
                                                    : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-blue-300 dark:hover:border-blue-600'}`, children: [userHasBooked && (_jsx("div", { className: "mb-3 p-2 bg-green-100 border border-green-300 rounded-lg", children: _jsx("p", { className: "text-xs text-green-800 font-medium flex items-center", children: "\u2705 You have booked this class" }) })), _jsxs("div", { className: "flex justify-between items-start mb-4", children: [_jsxs("div", { children: [_jsx("h3", { className: "font-bold text-lg text-gray-900 dark:text-white mb-1", children: schedule.class_type.name }), _jsx("p", { className: "text-blue-600 font-medium", children: getDayName(schedule.day_of_week) })] }), _jsx("span", { className: `px-3 py-1 rounded-full text-xs font-medium border ${getDifficultyColor(schedule.class_type.difficulty_level)}`, children: schedule.class_type.difficulty_level })] }), _jsxs("div", { className: "space-y-3 text-sm text-gray-600 dark:text-gray-300", children: [_jsxs("div", { className: "flex items-center", children: [_jsx(Clock, { className: "w-4 h-4 mr-2 text-blue-500" }), _jsxs("span", { className: "font-medium", children: [formatTime(schedule.start_time), _jsxs("span", { className: "text-gray-500 ml-1", children: ["(", schedule.duration_minutes, "min)"] })] })] }), _jsxs("div", { className: "flex items-center", children: [_jsx(Users, { className: "w-4 h-4 mr-2 text-green-500" }), _jsxs("span", { className: `font-medium ${getAvailabilityColor(schedule.current_bookings || 0, schedule.max_participants)}`, children: [schedule.current_bookings || 0, " / ", schedule.max_participants, " students"] }), _jsxs("span", { className: "ml-2 text-xs text-gray-500", children: ["(", availableSpots, " spots left)"] })] }), schedule.location && (_jsxs("div", { className: "flex items-center", children: [_jsx(MapPin, { className: "w-4 h-4 mr-2 text-purple-500" }), _jsx("span", { children: schedule.location })] })), schedule.class_type.price && (_jsxs("div", { className: "flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-700", children: [_jsxs("span", { className: "font-semibold text-blue-600 dark:text-blue-400 text-lg", children: ["$", schedule.class_type.price] }), _jsx(Button, { size: "sm", className: `text-xs transition-all ${userHasBooked
                                                                        ? 'bg-green-500 cursor-not-allowed'
                                                                        : isFullyBooked
                                                                            ? 'bg-gray-400 cursor-not-allowed'
                                                                            : isAlmostFull
                                                                                ? 'bg-orange-500 hover:bg-orange-600 animate-pulse'
                                                                                : ''}`, onClick: () => handleQuickBook(schedule), disabled: bookingLoading === schedule.id || isFullyBooked || userHasBooked, children: bookingLoading === schedule.id ? (_jsxs(_Fragment, { children: [_jsx(LoadingSpinner, { size: "sm" }), "Booking..."] })) : userHasBooked ? ('✅ Already Booked') : isFullyBooked ? ('🔒 Fully Booked') : isAlmostFull ? (_jsxs(_Fragment, { children: ["\uD83D\uDD25 Book Now!", _jsx(ChevronRight, { className: "w-3 h-3 ml-1" })] })) : (_jsxs(_Fragment, { children: ["\uD83D\uDCC5 Book Now", _jsx(ChevronRight, { className: "w-3 h-3 ml-1" })] })) })] }))] }), schedule.class_type.description && (_jsx("div", { className: "mt-4 pt-4 border-t border-gray-100 dark:border-gray-700", children: _jsx("p", { className: "text-xs text-gray-600 dark:text-gray-400 leading-relaxed", children: schedule.class_type.description }) })), isFullyBooked ? (_jsx("div", { className: "mt-3 p-2 bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded-lg", children: _jsx("p", { className: "text-xs text-red-800 dark:text-red-200 font-medium", children: "\uD83D\uDD34 This class is fully booked" }) })) : isAlmostFull ? (_jsx("div", { className: "mt-3 p-2 bg-orange-50 dark:bg-orange-900 border border-orange-200 dark:border-orange-700 rounded-lg", children: _jsxs("p", { className: "text-xs text-orange-800 dark:text-orange-200 font-medium", children: ["\u26A1 Only ", availableSpots, " spots left - Book now!"] }) })) : (_jsx("div", { className: "mt-3 p-2 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg", children: _jsxs("p", { className: "text-xs text-green-800 dark:text-green-200 font-medium", children: ["\u2705 ", availableSpots, " spots available"] }) })), _jsx("div", { className: "mt-3 pt-3 border-t border-gray-100 dark:border-gray-700", children: _jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: ["Next class: ", (() => {
                                                                const today = new Date();
                                                                const daysUntilClass = (schedule.day_of_week - today.getDay() + 7) % 7;
                                    ...
                                    }) }))] }) })), activeTab === 'certifications' && (_jsx("div", { className: "space-y-6", children: _jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6", children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center", children: [_jsx(GraduationCap, { className: "w-6 h-6 mr-3 text-blue-600" }), "Certifications & Qualifications"] }), !instructor.certifications || instructor.certifications.length === 0 ? (_jsxs("div", { className: "text-center py-12", children: [_jsx(GraduationCap, { className: "w-16 h-16 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white mb-2", children: "No Certifications Listed" }), _jsx("p", { className: "text-gray-500 dark:text-gray-400", children: "This instructor hasn't added their certifications yet." })] })) : (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: instructor.certifications.map((certification, index) => (_jsx("div", { className: "bg-gradient-to-br from-blue-50 to-green-50 dark:from-blue-900 dark:to-green-900 border border-blue-200 dark:border-blue-700 rounded-xl p-6 hover:shadow-md transition-shadow", children: _jsxs("div", { className: "flex items-start space-x-4", children: [_jsx("div", { className: "w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0", children: _jsx(GraduationCap, { className: "w-6 h-6 text-white" }) }), _jsxs("div", { className: "flex-1", children: [_jsx("h3", { className: "font-bold text-lg text-gray-900 dark:text-white mb-2", children: certification }), _jsxs("div", { className: "flex items-center text-sm text-gray-600 dark:text-gray-300", children: [_jsx(Award, { className: "w-4 h-4 mr-2 text-blue-500" }), _jsx("span", { children: "Certified Professional" })] })] })] }) }, index))) })), _jsxs("div", { className: "mt-8 pt-8 border-t border-gray-200", children: [_jsx("h3", { className: "text-xl font-semibold text-gray-900 dark:text-white mb-4", children: "Professional Experience" }), _jsx("div", { className: "bg-gray-50 dark:bg-gray-700 rounded-lg p-6", children: _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 text-center", children: [_jsxs("div", { children: [_jsx("div", { className: "text-3xl font-bold text-blue-600", children: instructor.experience_years || 0 }), _jsx("div", { className: "text-sm text-gray-600 dark:text-gray-300 mt-1", children: "Years Teaching" })] }), _jsxs("div", { children: [_jsx("div", { className: "text-3xl font-bold text-green-600", children: stats?.total_classes || 0 }), _jsx("div", { className: "text-sm text-gray-600 dark:text-gray-300 mt-1", children: "Classes Taught" })] }), _jsxs("div", { children: [_jsx("div", { className: "text-3xl font-bold text-purple-600", children: stats?.total_students || 0 }), _jsx("div", { className: "text-sm text-gray-600 dark:text-gray-300 mt-1", children: "Students Guided" })] })] }) })] })] }) })), activeTab === 'reviews' && (_jsx("div", { className: "space-y-6", children: _jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6", children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center", children: [_jsx(Star, { className: "w-6 h-6 mr-3 text-yellow-500" }), "Student Reviews"] }), stats && (_jsx("div", { className: "bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900 dark:to-orange-900 rounded-lg p-6 mb-8", children: _jsxs("div", { className: "flex items-center justify-center space-x-8", children: [_jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-4xl font-bold text-gray-900 dark:text-white", children: stats.average_rating.toFixed(1) }), _jsx("div", { className: "flex justify-center mt-2", children: renderStars(stats.average_rating) }), _jsx("div", { className: "text-sm text-gray-600 dark:text-gray-300 mt-1", children: "Overall Rating" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-4xl font-bold text-gray-900 dark:text-white", children: stats.total_reviews }), _jsx("div", { className: "text-sm text-gray-600 dark:text-gray-300 mt-1", children: "Total Reviews" })] })] }) })), _jsxs("div", { className: "text-center py-12", children: [_jsx(Star, { className: "w-16 h-16 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white mb-2", children: "Reviews Coming Soon" }), _jsx("p", { className: "text-gray-500 dark:text-gray-400", children: "Student reviews will be displayed here once the review system is implemented." })] })] }) }))] })] }));
}
