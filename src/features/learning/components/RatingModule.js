...
export function RatingModule({ averageRating, totalRatings, userRating, onSubmitRating, className = '' }) {
    ...
    return (_jsxs("div", { className: `bg-white rounded-xl shadow-lg p-6 ${className}`, children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-4", children: "Rate this Article" }), _jsxs("div", { className: "mb-6", children: [_jsxs("div", { className: "flex items-center space-x-2 mb-2", children: [_jsx("div", { className: "flex space-x-1", children: renderStars(averageRating) }), _jsx("span", { className: "text-lg font-semibold text-gray-900", children: averageRating > 0 ? averageRating.toFixed(1) : 'No ratings yet' })] }), _jsx("p", { className: "text-sm text-gray-600", children: totalRatings === 0
                            ? 'Be the first to rate this article!'
                            : `Based on ${totalRatings} rating${totalRatings !== 1 ? 's' : ''}` })] }), _jsxs("div", { className: "border-t border-gray-200 pt-6", children: [_jsx("p", { className: "text-sm font-medium text-gray-700 mb-3", children: userRating ? 'Your rating:' : 'Rate this article:' }), _jsx("div", { className: "flex items-center space-x-1 mb-4", children: renderStars(userRating || hoveredRating || 0, true) }), userRating && (_jsx("p", { className: "text-sm text-green-600 mb-2", children: "Thank you for rating this article!" })), _jsx("p", { className: "text-xs text-gray-500", children: "Your rating helps other readers discover quality content." })] })] }));
}
