...
interface UseAssignmentRosterOptions {
    enabled?: boolean;
    autoReloadMs?: number;
}

interface UseAssignmentRosterResult {
 ...
 */
export function useAssignmentRoster(assignmentId: string | undefined, opts: UseAssignmentRosterOptions = {}): UseAssignmentRosterResult {
    ...
    const fetchRoster = useCallback(async () => {
        ...
        const mapped: RosterAttendee[] = (data || []).map((r: any) => ({
