-- Booking ID System Implementation
-- This adds booking ID generation and links bookings to class assignments
...
-- 6. Add client_name column to class_assignments for easy display
ALTER TABLE class_assignments 
ADD COLUMN IF NOT EXISTS client_name text;

-- Add client_email for additional reference
ALTER TABLE class_assignments 
...
-- 10. Add RLS policies for bookings if not already present
...
INSERT INTO bookings (
    user_id, class_name, instructor, class_date, class_time,
    first_name, last_name, email, phone, experience_level,
    special_requests, emergency_contact, emergency_phone, status
) VALUES (
    auth.uid(), 'Hatha Yoga', 'John Instructor', '2024-02-01', '10:00 AM',
    'Jane', 'Doe', 'jane.doe@example.com', '+1234567890', 'Beginner',
    'First time student', 'Emergency Contact', '+0987654321', 'confirmed'
);
*/